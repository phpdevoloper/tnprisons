...
try
{
    ...
    if (isset($page_id) && !empty($page_id)) {
        ...
        if (empty($result)) {
            $sql = "INSERT INTO page_content(page_content_en,page_id,updated_by) VALUES('$page_content','$page_id','$updated_by')";
            if (pg_query($db, $sql)) {
            ...
            $sql = "UPDATE page_content SET page_content_en = '$page_content', page_id = '$page_id',updated_by = '$updated_by' WHERE page_id = '".$result['page_id']."'";
            if (pg_query($db, $sql)) {

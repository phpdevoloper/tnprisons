    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header"><?php echo $_SESSION['user_data']; ?></span>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-user-edit mr-2"></i> View Profile
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item dropdown-footer logout">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            $current_page = "dashboard.php";
             ?>
          <li class="nav-item">
            <a href="dashboard.php" class="nav-link <?php echo basename($_SERVER['SCRIPT_FILENAME']) == $current_page?'active':''?>">
          ...
          <li class="nav-item">
            <a href="menu.php" class="nav-link <?php echo basename($_SERVER['SCRIPT_FILENAME']) == "menu.php"?'active':''?>">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Menu
              </p>
